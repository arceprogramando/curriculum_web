...
export const LOCALE_CONFIG: Record<Locale, {
  ...
  en: {
    ...
    metaDescription: 'Mid-Level Full Stack Developer with experience in React, Node.js and TypeScript. University Programming Technician (UTN, 2025). UNLaM Computer Engineering entrance course. Explore my portfolio and projects.',
