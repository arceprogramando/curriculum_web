# SEO y SEM — arceprog.dev

Documentación del portafolio **curriculum_web** (Astro 6, despliegue en Vercel).
...
**Skill en Cursor:** `.cursor/skills/seo-sem-arceprog/SKILL.md` (este proyecto).  
**Skill técnica Astro:** `.cursor/skills/astro-seo/SKILL.md`.

Auditoría anterior (marzo 2025): [../SEO-AUDIT-2025.md](../SEO-AUDIT-2025.md).
